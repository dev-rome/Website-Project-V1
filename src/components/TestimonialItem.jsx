...
function TestimonialItem({ testimonial }) {
  return (
    <div className="lg:max-w-sm bg-white/20 drop-shadow-[4px_4px_4px_rgba(255,255,255,0.5)] rounded-2xl pt-4 px-2 pb-14">
      ...
      <p className="font-roboto mt-12 mb-8">{testimonial.description}</p>
