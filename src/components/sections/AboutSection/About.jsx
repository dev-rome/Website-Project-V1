        ...
        <div className="grid md:grid-cols-8 lg:grid-cols-11">
          <div className="md:col-span-4 lg:col-span-5">
            <div className="grid grid-cols-3 lg:grid-cols-5">
              ...
              >
                ...
                {inView && (
                  <motion.img
                    ...
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.5 }}
                    className="relative right-[2.2rem] top-[0.6rem] 2xl:right-[3rem] w-44"
                    src={Hatchet}
                    alt="Image of the text Hatchet"
                  />
                )}
              </div>
              <p className="col-span-4 row-start-2 lg:col-span-5 font-roboto 2xl:text-lg mt-4">
              ...
              <p className="col-span-4 row-start-3 lg:col-span-5 font-roboto 2xl:text-lg mt-4">
          ...
          <div className="md:col-start-6 lg:col-start-8">
            <div className="grid grid-cols-6 md:grid-cols-1 lg:grid-cols-1 gap-y-14 md:gap-y-20 mt-11 md:mt-0">
              <div className="flex items-center gap-2 w-16 md:w-24 2xl:w-36 md:pt-20">
                <img src={Support} alt="Support" />
                <p className="font-zwodrei font-bold text-lg sm:text-2xl 2xl:text-3xl">
                  Support
                </p>
              </div>
              <div className="col-start-4 md:row-start-2 md:col-start-1 flex items-center w-16 md:w-24 2xl:w-36 gap-2">
                <img src={Collaboration} alt="Collaboration" />
                <p className="font-zwodrei font-bold text-lg sm:text-2xl 2xl:text-3xl">
                  Collaboration
                </p>
              </div>
              <div className="row-start-2 md:row-start-3 flex items-center w-16 md:w-24 2xl:w-36 gap-2">
