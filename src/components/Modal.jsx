...
function Modal({ testimonial, onClose }) {
  return (
    <div
      className={`absolute bg-[#C5E0E3] shadow-[0_10px_4px_rgba(0,0,0,0.25)] backdrop-blur-[2px] rounded-2xl lg:pt-7 lg:px-14 lg:pb-11`}
    >
      <div className="grid lg:grid-cols-4">
        ...
        <div className="grid col-span-4 gap-y-8 lg:mt-6">
